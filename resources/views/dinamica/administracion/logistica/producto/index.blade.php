...
@section('script')
    ...
    <script src="{{ asset('assets/pages/scripts/administracion/logistica/compra/index.js') }}" type="text/javascript">
    </script>
@endsection
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('editar_producto', ['id' => $producto->id]) }}"
                                            class="btn-accion-tabla tooltips" title="Editar este registro">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <form action="{{ route('eliminar_producto', ['id' => $producto->id]) }}"
