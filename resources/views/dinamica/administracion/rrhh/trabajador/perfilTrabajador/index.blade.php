...
@section('contenido2')
            ...
            <div class="tab-pane" id="acciones">
                ...
                @if (isset($data->periodos->last()->fecha_fin))
                    <a class="btn btn-app bg-primary"
                        href="{{ route('crear_periodo_trabajador', ['id' => $data->id]) }}">
                ...
                <a class="btn btn-app bg-warning"
                    href="{{ route('crear_observacion_trabajador', ['id' => $data->id]) }}">
                ...
                @elseif (isset($data->periodos->last()->fecha_inicio))
                    <a class="btn btn-app bg-primary"
                        href="{{ route('crear_ascenso_trabajador', ['id' => $data->id]) }}">
    ...
    {{-- Modal calendario --}}
    <div class="modal fade" id="modalEvent" tabindex="-1" role="dialog" aria-labelledby="modalProductopLabel"
        aria-hidden="true">
