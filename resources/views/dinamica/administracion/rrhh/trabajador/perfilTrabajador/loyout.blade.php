                        ...
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Edad</b> <a class="float-right">{{ Carbon::parse($data->fecha_nacimiento)->age }}
                                        años</a>
                                </li>
                                <li class="list-group-item">
                            ...
                            @if (isset($data->periodos->last()->fecha_fin))
                                <a href="{{ route('crear_periodo_trabajador', ['id' => $data->id]) }}"
                                    class="btn btn-primary btn-block"><b>Contratar</b></a>
                            @elseif (isset($data->periodos->last()->fecha_inicio))
                                <a href="{{ route('crear_ascenso_trabajador', ['id' => $data->id]) }}"
                                    class="btn btn-primary btn-block"><b>Ascender</b></a>
                            @else
                                <a href="{{ route('crear_periodo_trabajador', ['id' => $data->id]) }}"
                                    class="btn btn-primary btn-block"><b>Contratar</b></a>
                            @endif
