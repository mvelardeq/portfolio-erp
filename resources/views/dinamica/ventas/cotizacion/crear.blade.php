    ...
    <div class="col-lg-12">
        ...
        <div class="card card-outline card-info">
            ...
            <form action="{{route('guardar_cotizacion')}}" id="form-general" class="form-horizontal" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    @include('dinamica.ventas.cotizacion.form')
                </div>
        ...
        <form class="form-item-coti" id="formitemcoti">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <textarea maxlength="900" name="descripcion" id="descripcion" class="form-control" cols="30" rows="5"></textarea>
        ...
        <form class="form-edit-item-coti" id="formedititemcoti">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <textarea maxlength="900" name="descripcion-edit" id="descripcion-edit" class="form-control" cols="30" rows="5"></textarea>
